...
// profile and your Lidar one, so editing your username here renames you there
...
// written here — it is capped at four entries, so book picks would overwrite
// the films pinned in the other app. Lidar's shelf leads with top-rated
