 ...
 * Lidar's violet (#8B5CF6, the accent the web app was built around) where
...
const dark = {
  ...
  '--primary': '258 90% 66%',
  // White on the violet fill, as Radar does on its blue. Near-black measures
  ...
  // here. The violet itself stays bright because it is also the icon and
...
export const COLORS = {
  ...
  accentSoft: 'hsla(258,90%,66%,0.15)',
