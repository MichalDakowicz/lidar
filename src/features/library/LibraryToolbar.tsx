...
import { activeFilterCount, useLibraryPrefs } from '@/store/libraryPrefs';
 ...
 */
export function LibraryToolbar({ searchQuery, onSearchChange, onOpenFilters, onOpenGrouping }: LibraryToolbarProps) {
