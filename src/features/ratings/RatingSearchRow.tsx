...
/**
 * A search hit on the ratings page. No add-to-library affordance anywhere on
    ...
    >
      ...
      <View className="min-w-0 flex-1">
        ...
        <Text numberOfLines={1} className="text-xs text-muted-foreground">
          {[authorsToDisplayString(release.authors), publishedYear(release.publishedDate)].filter(Boolean).join(' • ')}
        </Text>
      </View>
