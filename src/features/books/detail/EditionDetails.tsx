...
/**
 * The part of an book that is about *your* copy rather than the release:
 * where it came from, what it cost, its catalogue number, the tracks you keep
 * coming back to, and your notes.
 *
 * Only shown for a record you actually have — a wishlist entry has no edition
 * yet, and asking what you paid for something you do not own is nonsense.
 */
export function EditionDetails({ form, issues, onChange }: EditionDetailsProps) {
  return (
    <View className="gap-5">
      ...
      <View className="flex-row gap-4">
        ...
        <Field
          label="Catalogue no."
          value={form.edition}
          onChangeText={(edition) => onChange({ edition })}
      ...
      <Field
        ...
        placeholder="Edition quality, where you were when you first heard it…"
        multiline
      />
      ...
      <Field
        ...
        placeholder="https://open.googleBooks.com/book/…"
      />
